...
void TappingExplorationThread::moveIndexFingerBlocking(double angle)
{
...
void TappingExplorationThread::moveIndexFinger(double angle)
{
    _curProximal = angle;
    _curDistal = 90 - _curProximal;
    logFingertipControl();
